...
# Aplicar stubs
$classValidatorContent | Out-File -FilePath "node_modules\class-validator\index.d.ts" -Encoding UTF8 -Force
$classTransformerContent | Out-File -FilePath "node_modules\class-transformer\index.d.ts" -Encoding UTF8 -Force
$bcryptContent | Out-File -FilePath "node_modules\bcrypt\index.d.ts" -Encoding UTF8 -Force
