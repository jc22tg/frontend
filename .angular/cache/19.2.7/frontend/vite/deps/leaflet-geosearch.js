...
var v = function() {
  ...
  return e2.onFocus = function() {
    ...
    try {
      var e3 = this;
      return a(t4), u(r2 = e3.container, "error"), c(r2, "pending"), Promise.resolve(e3.handleSubmit({
        query: e3.input.value
      })).then(function() {
...
var g = function() {
  ...
  return e2.render = function(t4, e3) {
    ...
    void 0 === t4 && (t4 = []), this.clear(), t4.forEach(function(t5, n2) {
      ...
      o2.setAttribute("data-key", "" + n2), o2.innerHTML = e3({
        result: t5
...
var E = {
  ...
  initialize: function(r2) {
    ...
    this.options = e({}, y, r2), this.classNames = e({}, this.classNames, r2.classNames), this.markers = new t.FeatureGroup(), this.classNames.container += " leaflet-geosearch-" + this.options.style, this.searchElement = new v({
      ...
      handleClick: function(t3) {
        var e2 = t3.result;
        l2.searchElement.input.value = e2.label, l2.onSubmit({
          query: e2.label,
          data: e2
        });
      },
    ...
    }), this.searchElement.form.appendChild(this.resultList.container), this.searchElement.input.addEventListener("keyup", (n2 = function(t3) {
  ...
  showResult: function(t3, e2) {
    ...
    o2 && this.centerMap(t3), this.map.fireEvent("geosearch/showlocation", {
      location: t3,
      marker: s2
  ...
  addMarker: function(e2, r2) {
    ...
    return "function" == typeof a2 && (c2 = a2({
      query: r2,
      result: e2
    })), l2.bindPopup(c2), this.markers.addLayer(l2), s2 && l2.openPopup(), i2.draggable && l2.on("dragend", function(t3) {
  ...
  centerMap: function(e2) {
    ...
    !n2 && i2.isValid() && !e2.bounds || n2 || !i2.isValid() ? this.map.setView(s2.getCenter(), this.getZoom(), {
      animate: o2
...
var U = function(t3) {
  ...
  return n2.endpoint = function(t4) {
    var e3 = t4.query, r2 = "string" == typeof e3 ? {
      address: e3
    } : e3;
    ...
    return (null != (e3 = t4.data.geocodes) ? e3 : []).map(function(t5) {
      return {
        x: Number(t5.location.substring(0, t5.location.indexOf(","))),
        y: Number(t5.location.substring(t5.location.indexOf(",") + 1)),
        label: t5.formatted_address,
        bounds: null,
        raw: t5
      };
    });
...
var k = function(t3) {
  ...
  return n2.endpoint = function(t4) {
    ...
    return 0 === t4.data.resourceSets.length ? [] : t4.data.resourceSets[0].resources.map(function(t5) {
      return {
        x: t5.point.coordinates[1],
        y: t5.point.coordinates[0],
        label: t5.address.formattedAddress,
        bounds: [[t5.bbox[0], t5.bbox[1]], [t5.bbox[2], t5.bbox[3]]],
        raw: t5
      };
    });
    ...
    try {
      ...
      return Promise.resolve((e3 = i2.endpoint({
        query: o2,
        jsonp: a2
      }), r2 = a2, n3 = s("script", null, document.body), n3.setAttribute("type", "text/javascript"), new Promise(function(t5) {
...
var S = function(t3) {
  ...
  var n2 = e2.prototype;
  return n2.endpoint = function(t4) {
    var e3 = t4.query, r2 = t4.type, n3 = "string" == typeof e3 ? {
      q: e3
    } : e3;
    ...
    return (Array.isArray(t4.data) ? t4.data : [t4.data]).map(function(t5) {
      return {
        x: Number(t5.lon),
        y: Number(t5.lat),
        label: t5.display_name,
        bounds: [[parseFloat(t5.boundingbox[0]), parseFloat(t5.boundingbox[2])], [parseFloat(t5.boundingbox[1]), parseFloat(t5.boundingbox[3])]],
        raw: t5
      };
    });
  }, e2;
...
var L = function(t3) {
  ...
  return n2.endpoint = function(t4) {
    ...
    return t4.data.locations.map(function(t5) {
      return {
        x: t5.feature.geometry.x,
        y: t5.feature.geometry.y,
        label: t5.name,
        bounds: [[t5.extent.ymin, t5.extent.xmin], [t5.extent.ymax, t5.extent.xmax]],
        raw: t5
      };
    });
  }, e2;
...
var C = function(t3) {
  ...
  return n2.endpoint = function(t4) {
    var e3 = t4.query;
    return this.getUrl(t4.type === h.REVERSE ? this.reverseUrl : this.searchUrl, "string" == typeof e3 ? {
      q: e3
    } : e3);
  }, n2.parse = function(t4) {
    return t4.data.features.map(function(t5) {
      return {
        x: t5.geometry.coordinates[0],
        y: t5.geometry.coordinates[1],
        label: t5.properties.label,
        bounds: null,
        raw: t5
      };
    });
  ...
  return n2.endpoint = function(t4) {
    ...
    return (Array.isArray(t4.data.results) ? t4.data.results : [t4.data.results]).map(function(t5) {
      return {
        ...
        y: Number(t5.lat),
        label: t5.formatted,
        bounds: [[parseFloat(t5.bbox.lat1), parseFloat(t5.bbox.lon1)], [parseFloat(t5.bbox.lat2), parseFloat(t5.bbox.lon2)]],
        raw: t5
      };
    });
  }, e2;
...
var R = function(t3) {
  ...
  return n2.endpoint = function(t4) {
    var e3 = t4.query;
    return t4.type === h.REVERSE ? this.getUrl(this.host + "/v1/reverse", "string" == typeof e3 ? {} : e3) : this.getUrl(this.host + "/v1/autocomplete", "string" == typeof e3 ? {
      text: e3
    } : e3);
  }, n2.parse = function(t4) {
    return t4.data.features.map(function(t5) {
  ...
  return n2.endpoint = function(t4) {
    ...
    try {
      var e3 = function(e4) {
        ...
        return Promise.resolve(e4.geocode({
          address: t4.query
        }, function(t5) {
          return {
            results: t5
          ...
          return "ZERO_RESULTS" !== t5.code && console.error(t5.code + ": " + t5.message), {
            results: []
          };
        })).then(function(t5) {
          return r2.parse({
...
var q = function(t3) {
  ...
  return n2.endpoint = function(t4) {
    var e3 = t4.query;
    return this.getUrl(this.searchUrl, "string" == typeof e3 ? {
      address: e3
    } : e3);
  }, n2.parse = function(t4) {
    return t4.data.results.map(function(t5) {
      return {
        x: t5.geometry.location.lng,
        y: t5.geometry.location.lat,
        label: t5.formatted_address,
        bounds: [[t5.geometry.viewport.southwest.lat, t5.geometry.viewport.southwest.lng], [t5.geometry.viewport.northeast.lat, t5.geometry.viewport.northeast.lng]],
        raw: t5
      };
    });
  }, e2;
...
var D = function(t3) {
  ...
  return n2.endpoint = function(t4) {
    ...
    return (Array.isArray(t4.data.features) ? t4.data.features : []).map(function(t5) {
      var e3 = null;
      return t5.bbox && (e3 = [[parseFloat(t5.bbox[1]), parseFloat(t5.bbox[0])], [parseFloat(t5.bbox[3]), parseFloat(t5.bbox[2])]]), {
        x: Number(t5.center[0]),
        y: Number(t5.center[1]),
        label: t5.place_name ? t5.place_name : t5.text,
        bounds: e3,
        raw: t5
      };
    });
...
var G = function(t3) {
  ...
  return n2.endpoint = function(t4) {
    ...
    return t4.data.results.map(function(t5) {
      var e3 = null;
      return t5.bounds && (e3 = [[t5.bounds.southwest.lat, t5.bounds.southwest.lng], [t5.bounds.northeast.lat, t5.bounds.northeast.lng]]), {
        x: t5.geometry.lng,
        y: t5.geometry.lat,
        label: t5.formatted,
        bounds: e3,
